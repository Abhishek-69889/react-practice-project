...
const Home = (props) => {
  ...
  return (
    <div className='w-full h-165 flex justify-around gap-1.5 p-2'>
      ...
      <div className='w-100 h-auto bg-gray-100 p-3 flex flex-col gap-2 rounded-2xl m-10 overflow-auto'>
        ...
        <div className='my-1 flex justify-between gap-10 bg-gray-200 p-1 rounded-md '>
          ...
          <button className='rounded-sm bg-gray-500 px-2 text-green-300 cursor-pointer'>{props.category}</button>
        </div>
      </div>
    </div>
  )
